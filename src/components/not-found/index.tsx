...
const NotFound = () => {
  return (
    <section className="w-11/12 mx-auto my-0 min-h-screen h-screen relative">
      <h1 className="text-dark uppercase font-medium text-24 mt-2.5 font-inconsolata mb-16 sm:mb-48">
        404 not found
      </h1>
      <div className="sm:flex justify-between">
        <div className=" mb-10 flex-35 mr-28">
        ...
        <div className="flex-35">
          ...
          <button className="bg-dark text-white py-3 px-5 text-bold uppercase sm:text-14">
            Back to homepage
          </button>
        </div>
      </div>

      <p className="absolute top-95% text-14 w-full text-center font-bold">
